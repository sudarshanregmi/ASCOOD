...
parser.add_argument(
    ...
    type=str,
    default='cifar10',
    choices=['cifar10', 'cifar100', 'aircraft', 'cub', 'imagenet200', 'cars', 'waterbirds', 'celeba'])
parser.add_argument('--batch-size', type=int, default=200)
parser.add_argument('--save-csv', action='store_true')
parser.add_argument('--save-score', action='store_true')
parser.add_argument('--fsood', action='store_true')
parser.add_argument("--wrapper-net", type=str, default=None, choices=['T2FNormNet', 'ASCOODNet'])
...
NUM_CLASSES = {'cifar10': 10, 'cifar100': 100, 'imagenet200': 200, 'aircraft':
               90, 'cars': 150, 'waterbirds': 2, 'celeba': 2}
MODEL = {
    'cifar10': ResNet18_32x32,
    'cifar100': ResNet18_32x32,
    'imagenet200': ResNet18_224x224,
    'waterbirds': ResNet18_224x224,
    'celeba': ResNet18_224x224,
    'aircraft': ResNet50,
    'cars': ResNet50,
}
