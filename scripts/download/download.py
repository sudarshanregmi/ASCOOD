...
benchmarks_dict = {
    ...
    'cifar-100':
    ['cifar100', 'cifar10', 'tin', 'svhn', 'texture', 'places365', 'tin597', 'iSUN'],
    'imagenet-200': [
    ...
    'waterbirds': [
        'waterbirds', 'waterbirds_ood', 'ninco', 'inaturalist', 'texture',
        'openimage_o', 'sun'
    ],
    'celeba': [
        'celeba', 'ninco', 'inaturalist', 'texture', 'openimage_o', 'sun'
    ],
    'aircraft': [
        'aircraft', 'ninco', 'inaturalist', 'texture', 'openimage_o', 'sun'
    ],
    'cars': [
        'cars', 'ninco', 'inaturalist', 'texture', 'openimage_o', 'sun'
    ],
    'misc': [
        'cifar10c',
        'fractals_and_fvis',
...
dir_dict = {
    'images_classic/': [
        ...
        'fractals_and_fvis', 'usps', 'texture', 'notmnist', 'iSUN'
    ],
    'images_largescale/': [
        'imagenet_1k',
        'species_sub',
...
download_id_dict = {
    ...
    'cifar10_ascood_net_ascood_e100_lr0.1_w1.0_p0.2_otype_shuffle_nmg_1.0_1.0_random': '1Xod5Atx18-er01kwWeC5Q2wfez2XGBy5',
    'cifar100_ascood_net_ascood_e100_lr0.1_w5.0_p0.1_otype_shuffle_nmg_1.0_1.0_default': '1XF_Oe-4LBptVGyzHSJEa2n5Nw7Jyzbgu',
    'waterbirds_ascood_net_ascood_e30_lr0.01_w0.1_p0.1_otype_gradient_nmg_30.0_300.0_default': '1xhwvlDzkthwWPJABQiE87RzM9-s0ewzV',
    'celeba_ascood_net_ascood_e30_lr0.01_w1.0_p0.05_otype_gradient_nmg_30.0_50.0_default': '1Yh7-SQ8cbAhQu55skXmq4jMHW8CYr_Lv',
    'celeba_ascood_net_ascood_e30_lr0.01_w1.0_p1.0_otype_gaussian_nmg_0.1_0.1_default': '1IyOXT4X3eNVuKx9G0MC1cje4g1IoSt0Z',
    'aircraft_ascood_net_ascood_e30_lr0.01_w1.0_p0.1_otype_gradient_nmg_0.1_0.1_default': '1afI8fhNlOn70H0cXyd9KGxOuzI9jJ5KS',
    'cars_ascood_net_ascood_e30_lr0.01_w1.0_p0.1_otype_gradient_nmg_0.1_0.1_default': '1J5ZoNwyHQyD5nFjA0C4xOwwhQPH95GgV',
    'benchmark_imglist': '1U65KbMfo5O8egsuTIOtRg7AxOGChsWVT',
    ...
    'waterbirds': '1BG55OwcGIX6zcKf8T91mpGXVPTSRy__x',
    'waterbirds_ood': '1nVXLRWUQLQvr3bkjkSUb8seS8RY-AYjW',
    'celeba': '1b8KvtdEOat-FAGosBeIDZgCHMTVJnQOD',
    'aircraft': '1sJBmmx7ZVnjecp5HWuhfYfT1PcMf1hgm',
    'cars': '1MXSIR4CuStAMiJLR7HQoa1xlBXt4jrf4',
    'iSUN': '1Obk85N0UTkOJcnmHgYfQZM2LeMxbttvb',
}
...
if __name__ == '__main__':
    ...
    elif args.datasets[0] == 'ascood':
        args.datasets = [
            'cifar-10', 'cifar-100', 'celeba', 'waterbirds', 'cars', 'aircraft'
        ]
    ...
    elif args.checkpoints[0] == 'ascood':
        args.checkpoints = [
            'cars_ascood_net_ascood_e30_lr0.01_w1.0_p0.1_otype_gradient_nmg_0.1_0.1_default',
            'celeba_ascood_net_ascood_e30_lr0.01_w1.0_p0.05_otype_gradient_nmg_30.0_50.0_default',
            'celeba_ascood_net_ascood_e30_lr0.01_w1.0_p1.0_otype_gaussian_nmg_0.1_0.1_default',
            'cifar100_ascood_net_ascood_e100_lr0.1_w5.0_p0.1_otype_shuffle_nmg_1.0_1.0_default',
            'cifar10_ascood_net_ascood_e100_lr0.1_w1.0_p0.2_otype_shuffle_nmg_1.0_1.0_random',
            'waterbirds_ascood_net_ascood_e30_lr0.01_w0.1_p0.1_otype_gradient_nmg_30.0_300.0_default',
            'aircraft_ascood_net_ascood_e30_lr0.01_w1.0_p0.1_otype_gradient_nmg_0.1_0.1_default',
        ]
    ...
    for content in args.contents:
        if content == 'datasets':
            ...
            if 'v1.5' in args.checkpoints[0] or 'ascood' in args.checkpoints[0]:
