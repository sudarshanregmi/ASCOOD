    ...
    'aircraft': {
        ...
        'ood': {
            ...
            'near': {
                ...
                'aircraft_ood': {
                    'data_dir': 'images_largescale/',
                    'imglist_path': 'benchmark_imglist/aircraft/aircraft_ood.txt'
                }
            },
            'far': {
    ...
    'cars': {
        ...
        'ood': {
            ...
            'near': {
                ...
                'cars_ood': {
                    'data_dir': 'images_largescale/',
                    'imglist_path': 'benchmark_imglist/cars/cars_ood.txt'
                }
            },
            'far': {
                'datasets': ['ninco', 'openimage_o', 'sun', 'texture', 'inaturalist'],
    ...
    'waterbirds': {
        ...
        'ood': {
            ...
            'near': {
                ...
                'waterbirds_ood': {
                    'data_dir': 'images_largescale/',
                    'imglist_path': 'benchmark_imglist/waterbirds/waterbirds_ood.txt'
                }
            },
            'far': {
                'datasets': ['ninco', 'openimage_o', 'sun', 'texture', 'inaturalist'],
    ...
    'celeba': {
        ...
        'ood': {
            ...
            'near': {
                ...
                'celeba_ood': {
                    'data_dir': 'images_largescale/',
                    'imglist_path': 'benchmark_imglist/celeba/celeba_ood.txt'
                }
            },
            'far': {
                'datasets': ['ninco', 'openimage_o', 'sun', 'texture', 'inaturalist'],
...
download_id_dict = {
    ...
    'places_land_water': '140XuF1oXkCpwbzeG-Rgj4qwArR4Rq8IF',
...
benchmarks_dict = {
    ...
    'waterbirds':
    ['waterbirds', 'places_land_water', 'ninco', 'inaturalist', 'texture', 'openimage_o', 'sun'],
    'celeba':
