...
DATA_INFO = {
    'cifar10': {
        ...
        'ood': {
            ...
            'far': {
                'datasets': ['mnist', 'svhn', 'iSUN', 'texture', 'places365'],
                'mnist': {
                    'data_dir': 'images_classic/',
                ...
                'iSUN': {
                    'data_dir': 'images_classic/iSUN/',
                    'imglist_path': 'benchmark_imglist/cifar10/test_isun.txt'
                },
                'texture': {
                    'data_dir': 'images_classic/',
                    'imglist_path':
    ...
    'aircraft': {
        ...
        'id': {
            'train': {
                'data_dir': 'images_largescale/aircraft/',
                'imglist_path': 'benchmark_imglist/aircraft/aircraft_train.txt'
            },
            'val': {
                'data_dir': 'images_largescale/aircraft/',
                'imglist_path': 'benchmark_imglist/aircraft/aircraft_val.txt'
            },
            'test': {
                'data_dir': 'images_largescale/aircraft/',
                'imglist_path': 'benchmark_imglist/aircraft/aircraft_test.txt'
            }
        },
        'csid': {
            'datasets': [],
        ...
        'ood': {
            ...
            'near': {
                'datasets': ['aircraft_ood'],
                'aircraft_ood': {
                    'data_dir': 'images_largescale/aircraft/',
                    'imglist_path': 'benchmark_imglist/aircraft/aircraft_finegrained_ood.txt'
                }
            },
            'far': {
                'datasets': ['ninco', 'openimage_o', 'sun', 'texture', 'inaturalist'],
                'ninco': {
                    'data_dir': 'images_largescale/',
                ...
                'sun': {
                    'data_dir': 'images_largescale/',
                    'imglist_path': 'benchmark_imglist/sun/sun.txt'
                },
                'texture': {
                    'data_dir': 'images_classic/',
    ...
    'cars': {
        ...
        'id': {
            'train': {
                'data_dir': 'images_largescale/cars/',
                'imglist_path': 'benchmark_imglist/cars/cars_train.txt'
            },
            'val': {
                'data_dir': 'images_largescale/cars/',
                'imglist_path': 'benchmark_imglist/cars/cars_val.txt'
            },
            'test': {
                'data_dir': 'images_largescale/cars/',
                'imglist_path': 'benchmark_imglist/cars/cars_test.txt'
            }
        },
        'csid': {
            'datasets': [],
        ...
        'ood': {
            ...
            'near': {
                ...
                'cars_ood': {
                    'data_dir': 'images_largescale/cars/',
                    'imglist_path': 'benchmark_imglist/cars/cars_finegrained_ood.txt'
                }
            },
            'far': {
                'datasets': ['ninco', 'openimage_o', 'sun', 'texture', 'inaturalist'],
    ...
    'waterbirds': {
        ...
        'id': {
            'train': {
                'data_dir': 'images_largescale/waterbirds/',
                'imglist_path': 'benchmark_imglist/waterbirds/waterbirds_train.txt'
            },
            'val': {
                'data_dir': 'images_largescale/waterbirds/',
                'imglist_path': 'benchmark_imglist/waterbirds/waterbirds_val.txt'
            },
            'test': {
                'data_dir': 'images_largescale/waterbirds/',
                'imglist_path': 'benchmark_imglist/waterbirds/waterbirds_test.txt'
            }
        },
        'csid': {
            'datasets': [],
        ...
        'ood': {
            ...
            'near': {
                'datasets': ['waterbirds_ood'],
                'waterbirds_ood': {
                    'data_dir': 'images_largescale/waterbirds_ood/',
                    'imglist_path': 'benchmark_imglist/waterbirds/waterbirds_spurious_ood.txt'
                }
            },
            'far': {
                'datasets': ['ninco', 'openimage_o', 'sun', 'texture', 'inaturalist'],
    ...
    'celeba': {
        ...
        'id': {
            'train': {
                'data_dir': 'images_largescale/celeba/',
                'imglist_path': 'benchmark_imglist/celeba/celeba_train.txt'
            },
            'val': {
                'data_dir': 'images_largescale/celeba/',
                'imglist_path': 'benchmark_imglist/celeba/celeba_val.txt'
            },
            'test': {
                'data_dir': 'images_largescale/celeba/',
                'imglist_path': 'benchmark_imglist/celeba/celeba_test.txt'
            }
        },
        'csid': {
            'datasets': [],
        ...
        'ood': {
            ...
            'near': {
                ...
                'celeba_ood': {
                    'data_dir': 'images_largescale/celeba/',
                    'imglist_path': 'benchmark_imglist/celeba/celeba_spurious_ood.txt'
                }
            },
            'far': {
                'datasets': ['ninco', 'openimage_o', 'sun', 'texture', 'inaturalist'],
...
download_id_dict = {
    ...
    'waterbirds': '140XuF1oXkCpwbzeG-Rgj4qwArR4Rq8IF',
    'waterbirds_ood': '140XuF1oXkCpwbzeG-Rgj4qwArR4Rq8IF',
...
benchmarks_dict = {
    'cifar10':
    ['cifar10', 'cifar100', 'tin', 'mnist', 'svhn', 'iSUN', 'texture', 'places365'],
    'cifar100':
    ['cifar100', 'cifar10', 'tin', 'mnist', 'svhn', 'iSUN', 'texture', 'places365'],
    'waterbirds':
    ['waterbirds', 'waterbirds_ood', 'ninco', 'inaturalist', 'texture', 'openimage_o', 'sun'],
    'celeba':
